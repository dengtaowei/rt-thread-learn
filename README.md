...
### Team VS Code Debug Guide (qemu-vexpress-a9)

For local team workflow with QEMU + GDB + VS Code startup debugging, see:

- [docs/qemu-vexpress-a9-vscode-debug.md](docs/qemu-vexpress-a9-vscode-debug.md)
